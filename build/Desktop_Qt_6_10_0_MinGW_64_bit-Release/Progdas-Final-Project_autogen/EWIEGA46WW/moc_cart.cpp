...
template <> constexpr inline auto Cart::qt_create_metaobjectdata<qt_meta_tag_ZN4CartE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Cart, qt_meta_tag_ZN4CartE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Cart::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4CartE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4CartE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN4CartE_t>.metaTypes,
    nullptr
} };
...
void *Cart::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4CartE_t>.strings))
